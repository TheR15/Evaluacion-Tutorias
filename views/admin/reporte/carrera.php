    ...
    <div id="contenido" class="bg-white w-full">
        ...
        <div class="flex justify-between items-center m-10 bg-white rounded-xl drop-shadow-md z-0 relative">
            <div class="flex flex-col p-5">
                <h1 class="font-bold text-blue-600 text-xl">Reporte por carrera</h1>
                <p class="text-gray-600">Visualiza estadísticas y métricas de desempeño por carrera.</p>
            </div>
        </div>
        <div class="flex flex-col md:flex-row gap-5 m-10">
            <div class="bg-white rounded-xl drop-shadow-md p-5 w-auto h-auto">
                <div class="flex flex-col">
                    <h1 class="font-medium text-xl">Estadisticas por carrera</h1>
                    <p class="text-gray-600 mt-3">Elige un tutor para ver sus estadísticas</p>
                    <select id="select-carreras" name="tutor" class="w-full mt-3 border-gray-300 border-1 rounded-xl py-2 px-2 focus:outline-blue-500 focus:bg-blue-50 transition duration-500 ease-in-out outline-blue-500">
                        <option selected disabled value="">Selecciona una carrera</option>
                        ...
                        <option value="Ingenieria en Inovacion Agricola">Ingenieria en Inovacion Agricola</option>
                        <option value="Ingenieria en Geociencias">Ingenieria en Geociencias</option>
                        <option value="Ingenieria en Mecatronica">Ingenieria en Mecatronica</option>
                    </select>
                    <div id="container-preguntas" class="hidden flex flex-col gap-3 mt-3">
                        <h2>Pregunta</h2>
                    ...
                    <div id="totales" class="flex flex-col gap-3 hidden mt-3">
                        <h2>Estadísticas</h2>
                        ...
                        <div class="flex justify-between py-2 items-center bg-blue-50 px-3 py-1 rounded-md border-1 border-blue-200 text-blue-600 font-medium">
                            <h3 class="flex items-centerc gap-2"><svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#0000F5">
                                ...
                                </svg>Promedio de la carrera</h3>
                            <label for="" id="promedio" class="text-blue-600 font-bold"></label>
                        </div>
                    </div>
                    <div class="">
                        <button id="btn-generar-reporte" class="hidden mt-5 flex justify-center gap-2 w-full bg-blue-600 px-3 py-2 rounded-xl text-white font-bold cursor-pointer hover:bg-blue-700 hover:scale-110 transition-all">
            ...
            <div class="bg-white rounded-xl drop-shadow-md flex-1 p-5 flex flex-col min-h-[400px]">
                <div class="flex flex-col flex-1">
                    <h1 id="titulo-grafica" class="hidden font-medium text-xl mb-4">Grafica General</h1>
...
<script src="build/js/estadisticaCarrera.js"></script>
