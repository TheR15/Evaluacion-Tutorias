    ...
    <div id="contenido" class="bg-white w-full">
        ...
        <div class="flex justify-between items-center m-10 bg-white rounded-xl drop-shadow-md z-0 relative">
            <div class="flex flex-col p-5">
                <h1 class="font-bold text-blue-600 text-xl">Reporte General</h1>
                <p class="text-gray-600">Visualiza estadísticas y métricas de desempeño general de la institucion.</p>
            </div>
        </div>

        <div class="flex flex-col md:flex-row gap-5 m-10">
            <div class="bg-white rounded-xl drop-shadow-md p-5 w-auto h-auto">
                <h1 class="font-medium text-xl">Estadisiticas Generales</h1>
                <p class="text-gray-600 mt-3">Elige una pregunta para ver sus estadísticas</p>
                <div id="container-preguntas" class=" flex flex-col gap-3 mt-3">
                    <h2>Pregunta</h2>
                ...
                <div id="totales" class="flex flex-col gap-3 mt-3">
                    <h2>Estadísticas</h2>
            ...
            <div class="bg-white rounded-xl drop-shadow-md flex-1 p-5 flex flex-col min-h-[400px]">
                <div class="flex flex-col flex-1">
                    <h1 class="font-medium text-xl mb-4" id="titulo-grafica">Grafica General</h1>
...
<script src="build/js/estadisticasGeneral.js"></script>
