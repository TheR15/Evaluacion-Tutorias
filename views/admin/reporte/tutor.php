                ...
                <div class="flex flex-col h-full gap-5">
                    <div class="flex flex-col gap-5">
                        ...
                        <div id="totales" class="flex flex-col gap-3 hidden">
                            ...
                            <h2>Estadísticas</h2>
                            <div class="flex justify-between py-2 items-center px-3 py-1 rounded-md border-1 border-gray-200 text-gray-600 font-medium">
                            ...
                            <div class="flex justify-between py-2 items-center px-3 py-1 rounded-md border-1 border-gray-200 text-green-600 font-medium">
                            ...
                            <div class="flex justify-between py-2 items-center px-3 py-1 rounded-md border-1 border-red-200 text-red-600 font-medium">
                            ...
                            <div class="flex justify-between py-2 items-center bg-blue-50 px-3 py-1 rounded-md border-1 border-blue-200 text-blue-600 font-medium">
                                <h3 class="flex items-centerc gap-2"><svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#0000F5">
                                    ...
                                    </svg>Promedio del tutor</h3>
                                <label for="" id="promedioTutor" class="text-blue-600 font-bold"></label>
                            </div>
                        </div>
                    </div>

                    <div id="opciones-reporte" class="hidden flex flex-col gap-3">
                        <button id="btn-generar-reporte" class="flex justify-center gap-2 w-full bg-blue-600 px-3 py-2 rounded-xl text-white font-bold cursor-pointer hover:bg-blue-700 hover:scale-110 transition-all">
                            <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#FFFFFF">
                                <path d="M360-460h40v-80h40q17 0 28.5-11.5T480-580v-40q0-17-11.5-28.5T440-660h-80v200Zm40-120v-40h40v40h-40Zm120 120h80q17 0 28.5-11.5T640-500v-120q0-17-11.5-28.5T600-660h-80v200Zm40-40v-120h40v120h-40Zm120 40h40v-80h40v-40h-40v-40h40v-40h-80v200ZM320-240q-33 0-56.5-23.5T240-320v-480q0-33 23.5-56.5T320-880h480q33 0 56.5 23.5T880-800v480q0 33-23.5 56.5T800-240H320Zm0-80h480v-480H320v480ZM160-80q-33 0-56.5-23.5T80-160v-560h80v560h560v80H160Zm160-720v480-480Z" />
                            </svg>Descargar reporte</button>
                        <button id="btn-enviar-reporte" class="flex justify-center gap-2 w-full bg-gray-600 px-3 py-2 rounded-xl text-white font-bold cursor-pointer hover:bg-gray-700 hover:scale-110 transition-all">
                            <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#FFFFFF">
                                <path d="M120-160v-640l760 320-760 320Zm80-120 474-200-474-200v140l240 60-240 60v140Zm0 0v-400 400Z" />
                            </svg>Enviar reporte</button>
                    </div>
                </div>
            </div>
