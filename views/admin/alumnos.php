    ...
    <div id="contenido" class="bg-slate-100 w-full">
        ...
        <div class="m-10 bg-white rounded-xl drop-shadow-md z-0 relative">
            <div class="flex justify-between items-center p-5">
                <h1 class="font-bold text-blue-600 text-xl">Alumnos</h1>
                <button id="btn-crear" class="bg-blue-600 px-3 py-2 rounded-xl text-white font-bold cursor-pointer hover:bg-blue-700 hover:scale-110 transition-all">Agregar alumno</button>
            </div>
