...
function mostrarDatos() {
    ...
    general.forEach(general => {
        ...
        pregunta3 = Number.parseInt(general.totalPregunta3) || 0;
        pregunta4 = Number.parseInt(general.totalPregunta4) || 0;

        totalOpcion5Pregunta1 = Number.parseInt(general.p1_op5);
        totalOpcion4Pregunta1 = Number.parseInt(general.p1_op4);
        totalOpcion3Pregunta1 = Number.parseInt(general.p1_op3);
        totalOpcion2Pregunta1 = Number.parseInt(general.p1_op2);
        totalOpcion1Pregunta1 = Number.parseInt(general.p1_op1);

        totalOpcion5Pregunta2 = Number.parseInt(general.p2_op5);
        totalOpcion4Pregunta2 = Number.parseInt(general.p2_op4);
        totalOpcion3Pregunta2 = Number.parseInt(general.p2_op3);
        totalOpcion2Pregunta2 = Number.parseInt(general.p2_op2);
        totalOpcion1Pregunta2 = Number.parseInt(general.p2_op1);

        totalOpcion5Pregunta3 = Number.parseInt(general.p3_op5);
        totalOpcion4Pregunta3 = Number.parseInt(general.p3_op4);
        totalOpcion3Pregunta3 = Number.parseInt(general.p3_op3);
        totalOpcion2Pregunta3 = Number.parseInt(general.p3_op2);
        totalOpcion1Pregunta3 = Number.parseInt(general.p3_op1);

        totalOpcion5Pregunta4 = Number.parseInt(general.p4_op5);
        totalOpcion4Pregunta4 = Number.parseInt(general.p4_op4);
        totalOpcion3Pregunta4 = Number.parseInt(general.p4_op3);
        totalOpcion2Pregunta4 = Number.parseInt(general.p4_op2);
        totalOpcion1Pregunta4 = Number.parseInt(general.p4_op1);
...
async function enviarDatos() {
    ...
    try {
      ...
      `;
        ...
        a.href = urlPDF;
        a.download = 'Evaluacion Tutorias General';
